...
from application.models import Utilisateur, FormulaireStress
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for _ in range(num_records):
            ...
            patient = Utilisateur.objects.get(pk=patient_id)
            form_eval_stress = FormulaireStress(patient=patient, **data)
            form_eval_stress.save()

        self.stdout.write(self.style.SUCCESS(
            f'Successfully created {num_records} FormulaireEvalStress records.'))